...
test:
    ...
    python3 -m unittest scripts.test_agent_detection_manifest_check scripts.test_changelog scripts.test_config_reference_check scripts.test_delta_patches scripts.test_docs_translation_parity scripts.test_package_windows_conpty scripts.test_preview scripts.test_upstream_patches scripts.test_vendor_libghostty_vt scripts.test_vendor_portable_pty scripts.test_windows_installer
